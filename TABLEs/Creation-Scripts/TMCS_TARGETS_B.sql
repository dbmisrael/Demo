CREATE TABLE TMCS_TARGETS_B
   (	TARGET_ID NUMBER,
	...
	STRATEGY VARCHAR2(50) DEFAULT 'C',
	...
	SDA_ID NUMBER,
	FRANCHISE_TYPE VARCHAR2(50) DEFAULT 'OPEN',
 ...
 VARRAY GEOMETRY.SDO_ORDINATES STORE AS SECUREFILE LOB  ENABLE ROW MOVEMENT ;
  CREATE UNIQUE INDEX TMCS_TARGETS_B_PK ON TMCS_TARGETS_B (TARGET_ID)
  ;
ALTER TABLE TMCS_TARGETS_B ADD CONSTRAINT TMCS_TARGETS_B_PK PRIMARY KEY (TARGET_ID)
  USING INDEX TMCS_TARGETS_B_PK  ENABLE;
CREATE INDEX TMCS_TARGETS_B_INDX2 ON TMCS_TARGETS_B (TARGET_NUMBER, CLIENT_ID)
  ;
CREATE UNIQUE INDEX TMCS_TARGETS_B_PK ON TMCS_TARGETS_B (TARGET_ID)
  ;
CREATE INDEX TMCS_TARGETS_B_GIDX ON TMCS_TARGETS_B (GEOMETRY)
