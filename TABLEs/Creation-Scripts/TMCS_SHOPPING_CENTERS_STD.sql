CREATE TABLE TMCS_SHOPPING_CENTERS_STD
  ...
  CREATE UNIQUE INDEX TMCS_SHOPPING_CENTERS_STD_PK ON TMCS_SHOPPING_CENTERS_STD (SHOPPING_CENTER_ID)
  ;
ALTER TABLE TMCS_SHOPPING_CENTERS_STD ADD CONSTRAINT TMCS_SHOPPING_CENTERS_STD_PK PRIMARY KEY (SHOPPING_CENTER_ID)
  USING INDEX TMCS_SHOPPING_CENTERS_STD_PK  ENABLE;
CREATE INDEX TMCS_SHOPPING_CENTERS_STD_SRC ON TMCS_SHOPPING_CENTERS_STD (SHOPPING_CENTER_SRC_CODE)
  ;
CREATE UNIQUE INDEX TMCS_SHOPPING_CENTERS_STD_PK ON TMCS_SHOPPING_CENTERS_STD (SHOPPING_CENTER_ID)
  ;
CREATE UNIQUE INDEX TMCS_SHOPPING_CENTERS_STD_IDX2 ON TMCS_SHOPPING_CENTERS_STD (OBJECTID, SHOPPING_CENTER_SRC_CODE, COUNTRY)
  ;
CREATE INDEX TMCS_SHOP_CENTERS_STD_GIDX ON TMCS_SHOPPING_CENTERS_STD (GEOMETRY)
