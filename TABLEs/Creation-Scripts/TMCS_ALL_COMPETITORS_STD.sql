CREATE TABLE TMCS_ALL_COMPETITORS_STD
   (	COMPETITOR_ID NUMBER DEFAULT TMCS_ALL_COMPETITORS_S.NEXTVAL,
	...
	SOURCE VARCHAR2(50) DEFAULT 'STANDARD',
	ADD_ATTRIBUTES CLOB
   )
 ...
 VARRAY GEOMETRY.SDO_ORDINATES STORE AS SECUREFILE LOB ;
  CREATE UNIQUE INDEX TMCS_ALL_COMPETITORS_STD_PK ON TMCS_ALL_COMPETITORS_STD (COMPETITOR_ID)
  ;
ALTER TABLE TMCS_ALL_COMPETITORS_STD ADD CONSTRAINT TMCS_ALL_COMPETITORS_STD_PK PRIMARY KEY (COMPETITOR_ID)
  USING INDEX TMCS_ALL_COMPETITORS_STD_PK  ENABLE;
CREATE INDEX TMCS_ALL_COMPETITORS_STD_IDX ON TMCS_ALL_COMPETITORS_STD (CHAIN_ID, CHAIN_NAME, COUNTRY)
  ;
CREATE INDEX TMCS_ALL_COMPETITORS_STD_FIDX01 ON TMCS_ALL_COMPETITORS_STD (CLIENT_ID, UPPER(STORE_NAME))
  ;
CREATE INDEX TMCS_ALL_COMPETITORS_STD_INDX ON TMCS_ALL_COMPETITORS_STD (STATE)
  ;
CREATE INDEX TMCS_ALL_COMPETITORS_STD_GIDX ON TMCS_ALL_COMPETITORS_STD (GEOMETRY)
   INDEXTYPE IS MDSYS.SPATIAL_INDEX_V2  PARAMETERS ('WORK_TABLESPACE=SPTL_TS_INDX');
CREATE UNIQUE INDEX TMCS_ALL_COMPETITORS_UK_INDX ON TMCS_ALL_COMPETITORS_STD (HASH_ID)
  ;
CREATE INDEX TMCS_ALL_COMPETITORS_STD_INDX1 ON TMCS_ALL_COMPETITORS_STD (CITY)
  ;
CREATE UNIQUE INDEX TMCS_ALL_COMPETITORS_STD_PK ON TMCS_ALL_COMPETITORS_STD (COMPETITOR_ID)
  ;
