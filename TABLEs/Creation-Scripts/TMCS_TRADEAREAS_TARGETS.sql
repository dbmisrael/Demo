CREATE TABLE TMCS_TRADEAREAS_TARGETS
   (	TARGET_ID NUMBER,
 ...
 VARRAY GEOMETRY.SDO_ORDINATES STORE AS SECUREFILE LOB ;
  CREATE UNIQUE INDEX TMCS_TRADEAREAS_TARGETS ON TMCS_TRADEAREAS_TARGETS (TRADEAREA_ID)
  ;
ALTER TABLE TMCS_TRADEAREAS_TARGETS ADD CONSTRAINT TMCS_TRADEAREAS_TARGETS PRIMARY KEY (TRADEAREA_ID)
  USING INDEX TMCS_TRADEAREAS_TARGETS  ENABLE;
CREATE INDEX TMCS_TA_TARGETS_GIDX ON TMCS_TRADEAREAS_TARGETS (GEOMETRY)
