CREATE TABLE TMCS_STORE_STRATEGY_LOG
   (	STORE_STRATEGY_ID NUMBER,
	...
	D_EXT_ATTR15 DATE,
	N_EXT_ATTR6 NUMBER,
	SUB_STRATEGY VARCHAR2(100),
	 CONSTRAINT TMCS_STORE_STRATEGY_LOG_PK PRIMARY KEY (STORE_STRATEGY_LOG_ID)
  USING INDEX  ENABLE
   ) ;
