CREATE TABLE TMCS_SDA
   (	SDA_ID NUMBER,
	...
	C_EXT_LOV11 VARCHAR2(100),
	C_EXT_LOV12 VARCHAR2(100),
	C_EXT_LOV13 VARCHAR2(100),
	C_EXT_LOV14 VARCHAR2(100),
	C_EXT_LOV15 VARCHAR2(100)
   ) ;
  CREATE UNIQUE INDEX TMCS_SDA_PK ON TMCS_SDA (SDA_ID)
  ;
ALTER TABLE TMCS_SDA ADD CONSTRAINT TMCS_SDA_PK PRIMARY KEY (SDA_ID)
  USING INDEX TMCS_SDA_PK  ENABLE;
CREATE UNIQUE INDEX TMCS_SDA_PK ON TMCS_SDA (SDA_ID)
  ;
