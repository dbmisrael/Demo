CREATE TABLE TMCS_TARGETS_B_OLD
   (	TARGET_ID NUMBER,
 ...
 VARRAY GEOMETRY.SDO_ORDINATES STORE AS SECUREFILE LOB ;
  CREATE UNIQUE INDEX BIN$L8WCZYQLB5XgUwEAAH9f9A==$0 ON TMCS_TARGETS_B_OLD (TARGET_ID)
  ;
ALTER TABLE TMCS_TARGETS_B_OLD ADD CONSTRAINT BIN$L8WCZYQJB5XgUwEAAH9f9A==$0 PRIMARY KEY (TARGET_ID)
  USING INDEX BIN$L8WCZYQLB5XgUwEAAH9f9A==$0  ENABLE;
CREATE UNIQUE INDEX BIN$L8WCZYQLB5XgUwEAAH9f9A==$0 ON TMCS_TARGETS_B_OLD (TARGET_ID)
  ;
