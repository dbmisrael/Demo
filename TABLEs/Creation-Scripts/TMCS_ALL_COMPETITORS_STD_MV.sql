CREATE TABLE TMCS_ALL_COMPETITORS_STD_MV
 ...
 VARRAY GEOMETRY.SDO_ORDINATES STORE AS SECUREFILE LOB
  PARALLEL ;
CREATE INDEX TMCS_ALL_COMP_STD_MV_GIDX ON TMCS_ALL_COMPETITORS_STD_MV (GEOMETRY)
   INDEXTYPE IS MDSYS.SPATIAL_INDEX_V2  PARAMETERS ('layer_gtype=POINT sdo_dml_batch_size=5000  ');
