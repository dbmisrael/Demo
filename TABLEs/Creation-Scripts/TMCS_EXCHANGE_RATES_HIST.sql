CREATE TABLE TMCS_EXCHANGE_RATES_HIST
   (	EXCHG_RATE_ID NUMBER(15,0),
	...
	EXCHANGE_RATES_HIST_ID NUMBER DEFAULT TMCS_EXCHANGE_RATES_HIST_S.NEXTVAL,
	 CONSTRAINT TMCS_EXCHANGE_RATES_HIST_PK PRIMARY KEY (EXCHANGE_RATES_HIST_ID)
  USING INDEX  ENABLE
   ) ;
