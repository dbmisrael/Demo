CREATE TABLE TMCS_SHOPPING_CENTERS_CUSTOM
   (	OBJECTID NUMBER(38,0),
	...
	CUST_C_EXT_ATTR6 VARCHAR2(250),
	CUST_C_EXT_ATTR7 VARCHAR2(250),
	STATUS VARCHAR2(50),
	C_EXT_LOV11 VARCHAR2(200),
	CUST_COMMENTS VARCHAR2(4000),
	LAND_ID NUMBER,
	 CONSTRAINT TMCS_SHOP_CENTERS_CUSTM_PK PRIMARY KEY (CLIENT_ID, SHOPPING_CENTER_ID)
  USING INDEX  ENABLE
   )
 VARRAY GEOMETRY.SDO_ELEM_INFO STORE AS SECUREFILE LOB
 VARRAY GEOMETRY.SDO_ORDINATES STORE AS SECUREFILE LOB ;
CREATE INDEX TMCS_SHOP_CENTERS_CUST_GIDX ON TMCS_SHOPPING_CENTERS_CUSTOM (GEOMETRY)
