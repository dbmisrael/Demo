CREATE TABLE TMCS_MILESTONE_TEMPLATE_DETAIL
   (	TEMP_DETAIL_ID NUMBER DEFAULT tmcs.TMCS_MILESTONE_TEMPLATE_DTL_S.nextval,
	TEMPLATE_ID NUMBER,
...
CREATE INDEX TMCS_MILESTONE_TEMPLATE_DETAIL_INDX2 ON TMCS_MILESTONE_TEMPLATE_DETAIL (UPPER(MILESTONE_TYPE), TEMPLATE_ID)
  ;
