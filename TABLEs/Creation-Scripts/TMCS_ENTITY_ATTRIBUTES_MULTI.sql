CREATE TABLE TMCS_ENTITY_ATTRIBUTES_MULTI
   (	ATTRIBUTE_MULTI_ID NUMBER DEFAULT tmcs.tmcs_entity_attributes_multi_s.nextval,
	...
	DYN_EXT_LOV1 VARCHAR2(200),
	DYN_EXT_LOV2 VARCHAR2(200),
	DYN_EXT_LOV3 VARCHAR2(200),
	DYN_EXT_LOV4 VARCHAR2(200),
	DYN_EXT_LOV5 VARCHAR2(200),
	 CONSTRAINT TMCS_ENTITY_ATTR_MULTI_PK PRIMARY KEY (ATTRIBUTE_MULTI_ID)
  USING INDEX  ENABLE
   ) ;
CREATE INDEX TMCS_ENTITY_ATTR_MULTI_INDX01 ON TMCS_ENTITY_ATTRIBUTES_MULTI (ENTITY_ID, ENTITY_TYPE, TABLE_TYPE)
  ;
CREATE INDEX TMCS_ENTITY_ATTR_MULTI_INDX02 ON TMCS_ENTITY_ATTRIBUTES_MULTI (CLIENT_ID, ENTITY_TYPE, ENTITY_ID)
  ;
