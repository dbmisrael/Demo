CREATE TABLE TMCS_MAP_MENU_HEADERS
   (	MENU_HEADER_ID NUMBER DEFAULT TMCS_MAP_MENU_HEADERS_S.NEXTVAL,
	...
	IS_MOBILE_ENABLED VARCHAR2(320) DEFAULT 'TRUE',
	 CONSTRAINT TMCS_MAP_MENU_HEADERS_UNIQUE UNIQUE (MENU_ID, CLIENT_ID, BRAND_ID, BU_ID, COUNTRY)
  USING INDEX  ENABLE,
