CREATE TABLE TMCS_SITES_B
 ...
 VARRAY GEOMETRY.SDO_ORDINATES STORE AS SECUREFILE LOB  ENABLE ROW MOVEMENT ;
  CREATE UNIQUE INDEX TMCS_SITES_B_PK ON TMCS_SITES_B (SITE_ID)
  ;
ALTER TABLE TMCS_SITES_B ADD CONSTRAINT TMCS_SITES_B_PK PRIMARY KEY (SITE_ID)
  USING INDEX TMCS_SITES_B_PK  ENABLE;
CREATE INDEX TMCS_SITES_B_INDX2 ON TMCS_SITES_B (TARGET_ID, CLIENT_ID)
  ;
CREATE INDEX TMCS_SITES_B_INDX1 ON TMCS_SITES_B (CLIENT_ID)
  ;
CREATE INDEX TMCS_SITES_B_GIDX ON TMCS_SITES_B (GEOMETRY)
   INDEXTYPE IS MDSYS.SPATIAL_INDEX_V2  PARAMETERS ('WORK_TABLESPACE=SPTL_TS_INDX');
CREATE UNIQUE INDEX TMCS_SITES_B_PK ON TMCS_SITES_B (SITE_ID)
  ;
-- COMMENT --

   COMMENT ON COLUMN TMCS_SITES_B.CATEGORY IS 'Primary Site Flag';
