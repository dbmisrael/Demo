CREATE OR REPLACE FORCE EDITIONABLE VIEW MGV_ALL_STORED_PROGRAMS (PROJECT_ID, PROJECT_NAME, CONNECTION_ID, HOST, PORT, USERNAME, CATALOG_ID, CATALOG_NAME, SCHEMA_ID, SCHEMA_NAME, STORED_PROGRAM_ID, PROGRAMTYPE, STORED_PROGRAM_NAME, PACKAGE_ID_FK) AS
