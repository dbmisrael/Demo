CREATE OR REPLACE FORCE EDITIONABLE VIEW MGV_ALL_PARTITIONS_DETAILS (OBJTYPE, OBJNAME, OBJID, MAINOBJTYPE, MAINOBJNAME, MAINOBJID, SCHEMANAME, SCHEMAID, CATALOGNAME, CATALOGID, CONNNAME, CONNID, PROJECTNAME, PROJECTID, CAPTUREDORCONVERTED, QUALIFIEDNAME) AS
