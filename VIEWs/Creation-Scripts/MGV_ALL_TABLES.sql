CREATE OR REPLACE FORCE EDITIONABLE VIEW MGV_ALL_TABLES (PROJECT_ID, PROJECT_NAME, CONNECTION_ID, HOST, PORT, USERNAME, DBURL, CATALOG_ID, CATALOG_NAME, SCHEMA_ID, SCHEMA_NAME, TABLE_ID, TABLE_NAME) AS
