CREATE OR REPLACE FORCE EDITIONABLE VIEW MGV_ALL_VIEWS (PROJECT_ID, PROJECT_NAME, CONNECTION_ID, HOST, PORT, USERNAME, CATALOG_ID, CATALOG_NAME, DUMMY_FLAG, SCHEMA_ID, SCHEMA_NAME, VIEW_ID, VIEW_NAME) AS
