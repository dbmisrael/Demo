CREATE OR REPLACE FORCE EDITIONABLE VIEW MGV_ALL_SCHEMA (PROJECT_ID, PROJECT_NAME, CONNECTION_ID, HOST, PORT, USERNAME, CATALOG_ID, CATALOG_NAME, SCHEMA_ID, SCHEMA_NAME) AS
